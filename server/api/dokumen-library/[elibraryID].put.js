...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (
      ...
      !body.elibrary_mukaSurat ||
      !body.elibrary_noDocument ||
      !body.elibrary_namaPemilik ||
      !body.elibrary_peralatanDigunakan ||
      !body.elibrary_caraSemakan ||
      !body.elibrary_dapatan
    ) {
      return {
        statusCode: 400,
    ...
    // Update elibrary record with new fields
    const updatedElibrary = await prisma.elibrary.update({
      ...
      data: {
        ...
        elibrary_mukaSurat: body.elibrary_mukaSurat,
        elibrary_noDocument: body.elibrary_noDocument,
        elibrary_namaPemilik: body.elibrary_namaPemilik,
        elibrary_peralatanDigunakan: body.elibrary_peralatanDigunakan,
        elibrary_caraSemakan: body.elibrary_caraSemakan,
        elibrary_dapatan: body.elibrary_dapatan,
        updated_at: new Date(),
      },
      include: {
        document: true,
